...
import { Box, FormControl, Input, FormHelperText, FormErrorMessage, FormLabel, Button, Flex, useClipboard, InputGroup, InputLeftAddon } from '@chakra-ui/react';
import styles from './InputForm.module.css';

export const InputForm = () => {
    const [input, setInput] = useState({ longUrl: '', urlCode: '', firstName: '', lastName: '' });
    ...
    return (
        <Box width="40%" margin="auto" boxShadow="dark-lg" p="6" rounded="2xl" bg="dark" className={styles.mainContainer}>
            ...
            <InputGroup size='md' className={styles.InputGroup}>
                ...
                <Input placeholder='your personalized code ' id="urlCode" type="text" value={input.urlCode} onChange={handleInputChange} w='50%' onKeyDown={handleEnter} />
            </InputGroup>
            <Button type="submit" colorScheme="blue" m={5} onClick={handleSubmit} isLoading={isLoading} loadingText='Submitting'>
                Submit
            </Button>
            {url && <Flex mb={2}>
